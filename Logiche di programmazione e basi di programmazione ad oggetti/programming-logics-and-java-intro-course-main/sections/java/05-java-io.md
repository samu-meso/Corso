...
- [Input and Output Streams](#input-and-output-streams)
    - [Byte and Char Streams](#byte-and-char-streams)
    - [Reader and Writer Interfaces](#reader-and-writer-interfaces)
    - [Character Streams (Input)](#character-streams-input)
    - [Character Streams (Output)](#character-streams-output)
    - [Inputstream and Outputstream Interfaces](#inputstream-and-outputstream-interfaces)
    - [Byte Streams (Input)](#byte-streams-input)
    - [Byte Streams (Output)](#byte-streams-output)
...
<div align="center">
    <img src="assets/images/io-input-output-streams.png" width="500"
    style="background: white;"/>
</div>
<div align="center">
    <figcaption>
        <em>Input and output streams.</em>
        <br>
        <br>
    </figcaption>
</div>
...
<div align="center">
    <img src="assets/images/io-input-output-reader.png" width="500"/>
</div>
<div align="center">
    <figcaption>
        <em>Input and output readers organization.</em>
        <br>
        <br>
    </figcaption>
</div>
...
<div align="center">
    <img src="assets/images/io-input-output-stream-readers-workflow.png" width="500"/>
</div>
<div align="center">
    <figcaption>
        <em>Input and output readers organization.</em>
